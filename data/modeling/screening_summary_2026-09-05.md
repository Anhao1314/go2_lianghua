# go2w-quant 数据筛选报告（分层建模数据）：2026-09-05
...
|---|---|---|---|---|---|
| A | screened | **full**（LOO 无泄漏） | -0.9858 | 618897.8 | 6/6 |
| B | full | **full** | 0.215 | 477790.3 | 6/6 |
...
- 输出：screened_dataset_2026-09-05.csv（good）、anomaly_archive_2026-09-05.csv（非 good 归档）。
