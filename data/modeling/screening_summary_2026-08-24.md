# go2w-quant 数据筛选报告（分层建模数据）：2026-08-24
...
|---|---|---|---|---|---|
| A | screened | **full**（LOO 无泄漏） | -2.9704 | 380085.4 | 6/16 |
| B | full | **full** | 0.359 | 88639.9 | 16/16 |
...
- 输出：screened_dataset_2026-08-24.csv（good）、anomaly_archive_2026-08-24.csv（非 good 归档）。
