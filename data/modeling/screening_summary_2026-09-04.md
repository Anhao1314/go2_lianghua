# go2w-quant 数据筛选报告（分层建模数据）：2026-09-04
...
|---|---|---|---|---|---|
| A | screened | **full**（LOO 无泄漏） | -1.0475 | 650056.2 | 6/6 |
| B | full | **full** | 0.389 | 426750.6 | 6/6 |
...
- 输出：screened_dataset_2026-09-04.csv（good）、anomaly_archive_2026-09-04.csv（非 good 归档）。
