...
|---|---|---|---|---|---|
| A | screened | **full**（LOO 无泄漏） | -1.4682 | 215686.9 | 8/19 |
| B | full | **full** | -0.84 | 143179.4 | 19/19 |

### verdict 分类

- A（screened 训练，full 测试 LOO 无泄漏）：accuracy 0.8966（训练 pass/fail = 4/18，测试 n=29）
- B（full 训练，full 测试 LOO）：accuracy 0.931（pass/fail = 6/23）
