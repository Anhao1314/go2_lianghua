...
class LoadAllTablesTest(unittest.TestCase):
    ...
    def test_keys_and_shapes(self):
        ...
        self.assertEqual(len(tables["runs"]), 39)
        self.assertEqual(len(tables["eval_points"]), 1699)
        self.assertEqual(len(tables["tb_points"]), 11921)
        self.assertEqual(len(tables["snapshots"]), 28352)
        self.assertEqual(len(tables["reports"]), 22)
        self.assertEqual(len(tables["costs"]), 4)
        self.assertEqual(len(tables["labels"]), 39)
...
class PipelineEndToEndTest(unittest.TestCase):
    ...
    def test_stdout_summary(self):
        ...
        self.assertIn("标签分布: pass=3 / fail=23 / unknown=13", stdout)
    ...
    def test_label_distribution_matches_tables(self):
        ...
        self.assertEqual(counts, {"pass": 3, "fail": 23, "unknown": 13})
...
class IndividualScriptsStillWorkTest(unittest.TestCase):
    ...
    def test_run_functions_match_pipeline_outputs(self):
        ...
        self.assertEqual(len(enriched), 39)
